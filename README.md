...
You can find the third-party license texts generated by the Gradle OSS Licenses plugin in this repository under the `licenses/` directory:

- Full concatenated license text: [licenses/third_party/third_party_licenses.txt](licenses/third_party/third_party_licenses.txt)
- Per-component license files: [licenses/third_party/components/](licenses/third_party/components/)
- Extracted font license files: [licenses/fonts/](licenses/fonts/)
